        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <form action="" method="GET" class="filter-form">
                    <select name="rol_filtro" class="form-select">
                        <option value="">Todos los roles</option>
                        <option value="administrador" <?php echo $rol_filtro == 'administrador' ? 'selected' : ''; ?>>
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result_users)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge <?php echo $row['rol'] == 'administrador' ? 'bg-primary' : 'bg-secondary'; ?>">
