        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id=" . $id; ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="direccion_destino" class="form-control"
                    value="<?php echo $direccion_destino; ?>">
            </div>
            <div class="form-group">
                <label>Estado</label>
                <select name="estado_envio" class="form-control">
                    <option value="En Proceso" <?php echo ($estado_envio == "En Proceso") ? "selected" : ""; ?>>En Proceso
                    </option>
                    <option value="Completado" <?php echo ($estado_envio == "Completado") ? "selected" : ""; ?>>Completado
                    </option>
                </select>
            </div>
            <div class="form-group">
